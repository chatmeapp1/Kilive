...
export default function LiveTimesScreen() {
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.headerContent}>
            ...
            <ThemedText style={styles.headerTitle}>Live times</ThemedText>
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.resultsSection}>
            ...
            <View style={styles.tableHeader}>
              ...
              <ThemedText style={[styles.tableHeaderText, { flex: 1 }]}>Live times</ThemedText>
            </View>
        ...
        <LinearGradient
          ...
          style={styles.footer}
        >
          <ThemedText style={styles.footerText}>Current cumulative time: 0</ThemedText>
        </LinearGradient>
      </View>
    </>
  );

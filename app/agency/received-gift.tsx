      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.headerContent}>
            ...
            <ThemedText style={styles.headerTitle}>Received gift</ThemedText>
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.resultsSection}>
            ...
            <View style={styles.tableHeader}>
              ...
              <ThemedText style={[styles.tableHeaderText, { flex: 1.5 }]}>Number of Gifts</ThemedText>
            </View>
        ...
        <LinearGradient
          ...
          style={styles.footer}
        >
          <ThemedText style={styles.footerText}>Total Gift: 0</ThemedText>
        </LinearGradient>
      </View>
    </>
  );
